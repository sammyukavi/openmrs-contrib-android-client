...
public interface AddEditPatientContract {
	...
	interface View extends BaseView<Presenter> {
		...
		void setErrorsVisibility(boolean givenNameError, boolean familyNameError, boolean dayOfBirthError, boolean county_Error, boolean genderError, boolean patientFileNumberError,
