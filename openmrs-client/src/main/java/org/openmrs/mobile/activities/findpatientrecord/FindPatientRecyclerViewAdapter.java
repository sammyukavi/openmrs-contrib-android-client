...
class FindPatientRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    FindPatientRecyclerViewAdapter(Activity context, List<Patient> items, FindPatientRecordContract.View view) {
