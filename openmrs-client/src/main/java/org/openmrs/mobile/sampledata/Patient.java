...
public class Patient implements Serializable {
	...
	private Patient(String given_name, String middle_name, String family_name, String id, int age, char gender,
			int active_visit) {
	...
	public Patient newPatient(String given_name, String middle_name, String family_name, String id, int age, char gender,
			int active_visit) {
